...
CHARACTER(255), PARAMETER :: consid='$Id: cons.f90 20362 2014-08-29 20:23:22Z drjfloyd@gmail.com $'
CHARACTER(255), PARAMETER :: consrev='$Revision: 20362 $'
CHARACTER(255), PARAMETER :: consdate='$Date: 2014-08-29 15:23:22 -0500 (vie 29 de ago de 2014) $'

! Indices for various modes of operation

INTEGER :: RLIM=1,ZLIM=1                                                          ! For REACTION_SOURCE and LES correction
REAL(EB)::CT=0, CF=0, COX=0
...
INTEGER, PARAMETER :: NO_STOP=0, INSTABILITY_STOP=1, USER_STOP=2, SETUP_STOP=3, &
                      SETUP_ONLY_STOP=4, CTRL_STOP=5                                        ! Program Stop Status
...
LOGICAL :: LES,DNS,RADIATION=.TRUE.,KAPPA_ARRAY=.FALSE.,CYLINDRICAL,NOISE, &
           ...
           GRAVITATIONAL_DEPOSITION=.TRUE.,THERMOPHORETIC_DEPOSITION=.TRUE.,TURBULENT_DEPOSITION=.TRUE., &
           ...
           UVW_RESTART=.FALSE.,CUTCELL_DATA_FILE=.FALSE.,SECOND_ORDER_PARTICLE_TRANSPORT=.FALSE.,&
           RESEARCH_MODE=.FALSE.,EVAPORATION_DRAG=.FALSE.,KINETIC_ENERGY_SOURCE=.FALSE.,&
           ...
           CONSTANT_H_SOLID=.TRUE.,DO_Y_EQ=.FALSE.,EMBEDDED_MESH=.FALSE.,POTENTIAL_TEMPERATURE_CORRECTION=.FALSE.,&
           CAMBIO=.FALSE.,DOS_EQ=.FALSE.
...
REAL(EB) :: CPOPR,RSC,RPR,TMPA,TMPA4,RHOA,P_INF,&
            ...
            TMPM=273.15_EB, P_STP=101325._EB,GRAV=9.80665_EB,R0=8314.472_EB,R1=1.986257E-03_EB,SIGMA=5.670373E-8_EB, &
            Y_WERNER_WENGLE=11.81_EB,PARTICLE_CFL_MAX=1.0_EB,PARTICLE_CFL_MIN=0.8_EB,DELTA_IBM
...
REAL(EB) :: T_BEGIN,T_END,T_END_GEOM,TWFIN,TIME_SHRINK_FACTOR,RELAXATION_FACTOR=1._EB
...
INTEGER :: ICYC,WALL_INCREMENT,NFRAMES,PERIODIC_TEST=0,TURB_MODEL=0,SLIP_CONDITION=2,FISHPAK_BC(3)=-1,STOP_AT_ITER=0
