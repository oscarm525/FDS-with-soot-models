...
IMPLICIT NONE
CHARACTER(255), PARAMETER :: typeid='$Id: type.f90 20560 2014-09-26 12:37:27Z randy.mcdermott $'
CHARACTER(255), PARAMETER :: typerev='$Revision: 20560 $'
CHARACTER(255), PARAMETER :: typedate='$Date: 2014-09-26 07:37:27 -0500 (vie 26 de sep de 2014) $'
...
TYPE LAGRANGIAN_PARTICLE_CLASS_TYPE
   ...
   REAL(EB) :: HEAT_OF_COMBUSTION,ADJUST_EVAPORATION, &
               ...
               TMP_INITIAL,SIGMA,VERTICAL_VELOCITY,HORIZONTAL_VELOCITY,DRAG_COEFFICIENT, &
               SURFACE_TENSION,BREAKUP_RATIO,BREAKUP_GAMMA,BREAKUP_SIGMA,DENSE_VOLUME_FRACTION, &
...
INTEGER, PARAMETER :: N_PARTICLE_SCALAR_REALS=13,N_PARTICLE_SCALAR_INTEGERS=6,N_PARTICLE_SCALAR_LOGICALS=3
...
INTEGER, PARAMETER :: N_WALL_SCALAR_REALS=17,N_WALL_SCALAR_INTEGERS=10,N_WALL_SCALAR_LOGICALS=0

TYPE WALL_TYPE
   TYPE (ONE_D_M_AND_E_XFER_TYPE) :: ONE_D
   REAL(EB), POINTER, DIMENSION(:) :: A_LP_MPUA,LP_CPUA,LP_MPUA,AWM_AEROSOL,RHODW,ZZ_F,VEG_FUELMASS_L,VEG_MOISTMASS_L,VEG_TMP_L
   REAL(EB), POINTER :: AW,DUWDT,EW,KW,RAW,RDN,RHO_F,U_TAU,UVW_GHOST,UW0,XW,Y_PLUS,YW,ZW,VEG_HEIGHT,VEL_ERR_NEW,V_DEP
...
TYPE SPECIES_TYPE
   ...
   LOGICAL ::  ISFUEL=.FALSE.,LISTED=.FALSE.
...
TYPE SURFACE_TYPE
   REAL(EB) :: TMP_FRONT=-1._EB,TMP_BACK=-1._EB,VEL,VEL_GRAD,PLE,Z0,CONVECTIVE_HEAT_FLUX,NET_HEAT_FLUX, &
               ...
               DT_INSERT,H_FIXED=-1._EB,HM_FIXED=-1._EB,EMISSIVITY_BACK,CONV_LENGTH,XYZ(3),FIRE_SPREAD_RATE, &
               MINIMUM_LAYER_THICKNESS,INNER_RADIUS=0._EB
...
TYPE OMESH_TYPE
   REAL(EB), ALLOCATABLE, DIMENSION(:,:,:) :: MU,RHO,RHOS,U,V,W,US,VS,WS,H,HS,FVX,FVY,FVZ,D,DS,KRES
   REAL(EB), ALLOCATABLE, DIMENSION(:,:,:,:) :: ZZ,ZZS
   INTEGER, ALLOCATABLE, DIMENSION(:,:) :: IJKW
   INTEGER, ALLOCATABLE, DIMENSION(:) :: BOUNDARY_TYPE
   INTEGER, ALLOCATABLE, DIMENSION(:) :: N_PART_ORPHANS,N_PART_ADOPT
   TYPE(WALL_ILW_TYPE), ALLOCATABLE, DIMENSION(:) :: WALL_ILW
   ...
   REAL(EB), ALLOCATABLE, DIMENSION(:) :: &
         REAL_SEND_PKG1,REAL_SEND_PKG2,REAL_SEND_PKG3,REAL_SEND_PKG4,REAL_SEND_PKG5,REAL_SEND_PKG7,&
         REAL_RECV_PKG1,REAL_RECV_PKG2,REAL_RECV_PKG3,REAL_RECV_PKG4,REAL_RECV_PKG5,REAL_RECV_PKG7
...
TYPE OBSTRUCTION_TYPE
   ...
   LOGICAL :: HIDDEN=.FALSE.,PERMIT_HOLE=.TRUE.,ALLOW_VENT=.TRUE.,CONSUMABLE=.FALSE.,REMOVABLE=.FALSE., &
              THIN=.FALSE.,HOLE_FILLER=.FALSE.,NOTERRAIN=.FALSE.,OVERLAY=.TRUE.
...
TYPE DUCT_TYPE
   ...
   REAL(EB) :: ROUGHNESS,LENGTH, DIAMETER, AREA_INITIAL, AREA, CP_D, RHO_D,TMP_D,LOSS(2)=0._EB,VEL(4)=0._EB,RSUM_D=0._EB,&
               ...
               VOLUME_FLOW=1.E6_EB,VOLUME_FLOW_INITIAL=1.E6_EB,X(2),Y(2),Z(2),TAU=-1._EB
   REAL(EB), ALLOCATABLE, DIMENSION(:) :: ZZ
