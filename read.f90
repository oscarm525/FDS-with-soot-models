...
IMPLICIT NONE
PRIVATE
CHARACTER(255), PARAMETER :: readid='$Id: read.f90 20564 2014-09-26 19:27:10Z mcgratta $'
CHARACTER(255), PARAMETER :: readrev='$Revision: 20564 $'
CHARACTER(255), PARAMETER :: readdate='$Date: 2014-09-26 14:27:10 -0500 (vie 26 de sep de 2014) $'
...
INTEGER :: FUEL_SMIX_INDEX = 1 ! Simple chemistry fuel index
...
CALL READ_DEAD    ; IF (PROCESS_STOP_STATUS==SETUP_STOP) RETURN
CALL READ_HEAD    ; IF (PROCESS_STOP_STATUS==SETUP_STOP) RETURN
CALL READ_MISC    ; IF (PROCESS_STOP_STATUS==SETUP_STOP) RETURN
CALL READ_MULT    ; IF (PROCESS_STOP_STATUS==SETUP_STOP) RETURN
CALL READ_MESH(1) ; IF (PROCESS_STOP_STATUS==SETUP_STOP) RETURN
CALL READ_EVAC(1) ; IF (PROCESS_STOP_STATUS==SETUP_STOP) RETURN
CALL READ_MESH(2) ; IF (PROCESS_STOP_STATUS==SETUP_STOP) RETURN
CALL READ_TRAN    ; IF (PROCESS_STOP_STATUS==SETUP_STOP) RETURN
CALL READ_TIME    ; IF (PROCESS_STOP_STATUS==SETUP_STOP) RETURN
CALL READ_PRES    ; IF (PROCESS_STOP_STATUS==SETUP_STOP) RETURN
CALL READ_REAC    ; IF (PROCESS_STOP_STATUS==SETUP_STOP) RETURN
CALL READ_SPEC    ; IF (PROCESS_STOP_STATUS==SETUP_STOP) RETURN
CALL PROC_REAC    ; IF (PROCESS_STOP_STATUS==SETUP_STOP) RETURN
CALL READ_RADI    ; IF (PROCESS_STOP_STATUS==SETUP_STOP) RETURN
CALL READ_PROP    ; IF (PROCESS_STOP_STATUS==SETUP_STOP) RETURN
CALL READ_DEVC    ; IF (PROCESS_STOP_STATUS==SETUP_STOP) RETURN
CALL READ_PART    ; IF (PROCESS_STOP_STATUS==SETUP_STOP) RETURN
CALL READ_CTRL    ; IF (PROCESS_STOP_STATUS==SETUP_STOP) RETURN
CALL READ_MATL    ; IF (PROCESS_STOP_STATUS==SETUP_STOP) RETURN
CALL READ_SURF    ; IF (PROCESS_STOP_STATUS==SETUP_STOP) RETURN
CALL READ_VERT    ; IF (PROCESS_STOP_STATUS==SETUP_STOP) RETURN
CALL READ_FACE    ; IF (PROCESS_STOP_STATUS==SETUP_STOP) RETURN
CALL READ_CSVF    ; IF (PROCESS_STOP_STATUS==SETUP_STOP) RETURN
CALL READ_VOLU    ; IF (PROCESS_STOP_STATUS==SETUP_STOP) RETURN
CALL READ_OBST    ; IF (PROCESS_STOP_STATUS==SETUP_STOP) RETURN
CALL READ_GEOM    ; IF (PROCESS_STOP_STATUS==SETUP_STOP) RETURN
CALL READ_VENT    ; IF (PROCESS_STOP_STATUS==SETUP_STOP) RETURN
CALL READ_ZONE    ; IF (PROCESS_STOP_STATUS==SETUP_STOP) RETURN
CALL READ_EVAC(2) ; IF (PROCESS_STOP_STATUS==SETUP_STOP) RETURN
CALL READ_HVAC    ; IF (PROCESS_STOP_STATUS==SETUP_STOP) RETURN
CALL PROC_SURF_1  ; IF (PROCESS_STOP_STATUS==SETUP_STOP) RETURN
CALL READ_RAMP    ; IF (PROCESS_STOP_STATUS==SETUP_STOP) RETURN
CALL PROC_SMIX    ; IF (PROCESS_STOP_STATUS==SETUP_STOP) RETURN
CALL PROC_HVAC    ; IF (PROCESS_STOP_STATUS==SETUP_STOP) RETURN
CALL PROC_MATL    ; IF (PROCESS_STOP_STATUS==SETUP_STOP) RETURN
CALL PROC_SURF_2  ; IF (PROCESS_STOP_STATUS==SETUP_STOP) RETURN
CALL READ_DUMP    ; IF (PROCESS_STOP_STATUS==SETUP_STOP) RETURN
CALL READ_CLIP    ; IF (PROCESS_STOP_STATUS==SETUP_STOP) RETURN
CALL PROC_WALL    ; IF (PROCESS_STOP_STATUS==SETUP_STOP) RETURN
CALL PROC_PART    ; IF (PROCESS_STOP_STATUS==SETUP_STOP) RETURN
CALL READ_INIT    ; IF (PROCESS_STOP_STATUS==SETUP_STOP) RETURN
CALL READ_TABL    ; IF (PROCESS_STOP_STATUS==SETUP_STOP) RETURN
CALL PROC_CTRL    ; IF (PROCESS_STOP_STATUS==SETUP_STOP) RETURN
CALL PROC_PROP    ; IF (PROCESS_STOP_STATUS==SETUP_STOP) RETURN
CALL PROC_DEVC    ; IF (PROCESS_STOP_STATUS==SETUP_STOP) RETURN
CALL PROC_OBST    ; IF (PROCESS_STOP_STATUS==SETUP_STOP) RETURN
CALL READ_PROF    ; IF (PROCESS_STOP_STATUS==SETUP_STOP) RETURN
CALL READ_SLCF    ; IF (PROCESS_STOP_STATUS==SETUP_STOP) RETURN
CALL READ_ISOF    ; IF (PROCESS_STOP_STATUS==SETUP_STOP) RETURN
CALL READ_BNDF    ; IF (PROCESS_STOP_STATUS==SETUP_STOP) RETURN
CALL READ_BNDE    ; IF (PROCESS_STOP_STATUS==SETUP_STOP) RETURN
...
NAMELIST /MISC/ AL2O3,ALLOW_SURFACE_PARTICLES,ALLOW_UNDERSIDE_PARTICLES,ASSUMED_GAS_TEMPERATURE,ASSUMED_GAS_TEMPERATURE_RAMP,&
                ...
                WIND_ONLY,CONSTANT_H_SOLID,CAMBIO,DOS_EQ,REAC_SOURCE_CHECK,RLIM,ZLIM, CT, CF, COX 
...
REAL(EB) :: MW,SIGMALJ,EPSILONKLJ,VISCOSITY,CONDUCTIVITY,DIFFUSIVITY,MASS_EXTINCTION_COEFFICIENT, &
            ...
            CONVERSION
REAL(EB):: MASS_FRACTION(MAX_SPECIES),VOLUME_FRACTION(MAX_SPECIES)
INTEGER  :: N_SPEC_READ,N,NN,NS2,NR,N_SPEC_READ_2,N_SUB_SPECIES,NS
...
ALLOCATE(PREDEFINED_SMIX(0:MINT_SPECIES))
...
PRIMITIVE_SPEC_READ_LOOP: DO WHILE (N_SPEC_READ < N_SPEC_READ_2 .OR. N < N_SPECIES)
   ...
   ELSE
      ...
      N_SPEC_READ = N_SPEC_READ + 1
      IF (SIMPLE_CHEMISTRY) THEN
         IF(TRIM(ID)==TRIM(REACTION(1)%FUEL)) PREDEFINED_SMIX(1)=.FALSE.
      ENDIF
   ENDIF
...
IF (SIMPLE_CHEMISTRY) THEN
   ...
   RN%NU_READ(3)      = -(RN%NU_READ(1)*SPECIES_MIXTURE(FUEL_SMIX_INDEX)%MW+RN%NU_READ(2)*SPECIES_MIXTURE(0)%MW)/ &
                        SPECIES_MIXTURE(2)%MW
   RN%N_SMIX          = 3
ENDIF
...
CHARACTER(LABEL_LENGTH) :: PART_ID,RAMP_MF(MAX_SPECIES),RAMP_Q,RAMP_V,RAMP_T,MATL_ID(MAX_LAYERS,MAX_MATERIALS),&
                 ...
                 RAMP_T_I,RAMP_V_X,RAMP_V_Y,RAMP_V_Z
...
READ_SURF_LOOP: DO N=0,N_SURF
   ...
   ALLOCATE(SF%MASS_FRACTION(0:N_TRACKED_SPECIES),STAT=IZERO)
   CALL ChkMemErr('READ','SURFACE',IZERO) ; SF%MASS_FRACTION = 0._EB
   ALLOCATE(SF%MASS_FLUX(0:N_TRACKED_SPECIES),STAT=IZERO)
   ...
   ALLOCATE(SF%RAMP_MF(0:N_TRACKED_SPECIES),STAT=IZERO)
