...
CHARACTER(255), PARAMETER :: meshid='$Id: mesh.f90 19983 2014-07-23 21:07:09Z randy.mcdermott $'
CHARACTER(255), PARAMETER :: meshrev='$Revision: 19983 $'
CHARACTER(255), PARAMETER :: meshdate='$Date: 2014-07-23 16:07:09 -0500 (mié 23 de jul de 2014) $'
...
TYPE MESH_TYPE
   ...
   REAL(EB), ALLOCATABLE, DIMENSION(:,:,:,:) :: EQ_VAP_FRAC
   ...
   INTEGER :: N_WALL_CELLS,N_WALL_CELLS_DIM,N_INTERNAL_WALL_CELLS,N_EXTERNAL_WALL_CELLS,CELL_COUNT,WALL_COUNTER
   REAL(EB) :: BC_CLOCK
...
REAL(EB), POINTER, DIMENSION(:,:,:,:) :: EQ_VAP_FRAC
...
INTEGER, POINTER :: N_WALL_CELLS,N_WALL_CELLS_DIM,N_INTERNAL_WALL_CELLS,N_EXTERNAL_WALL_CELLS,CELL_COUNT,WALL_COUNTER
